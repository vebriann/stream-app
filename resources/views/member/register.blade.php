            ...
            <div class="pt-[30px] relative">
                ...
                <div class="pt-[85px] flex flex-col items-center gap-5 px-3">
                    ...
                    <section class="w-11/12 max-w-[460px]">
                        <form method="POST" action="{{ route('member.register.store') }}"  class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6">
                            @csrf
                            <div class="form-input flex flex-col gap-3">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Your complete name" name="name" />
                                @error('name')
